function ModelWork_factorialComparison(modelsummary,metric,modelnames,modelbase,prior,factors,factornames,hg,masks,factorfixed)
...
if isempty(masks); masks{1} = ones(1,size(factors{1},1)); end
...
for m = 1:Nmasks
    ...
    for k = 1:Nfgroups
        ...
        plotcomparison(modelsummary,metric,modelnames,modelbase,prior_one,bms, ...
...
%--------------------------------------------------------------------------
function bms = plotcomparison(modelsummary,metric,modelnames,bestmodel,prior,BMS,factornames,factors,plotflag,labelxticks,factorfixed)
